    ...
    \begin{itemize}
      ...
      \item Manage user account.
        \begin{itemize}
          ...
          \item Technology and Data Variations List:
            \begin{enumerate}
              \item User login with third part login service will need third part identity for the user.
              \item User's identity token for Timelog service.
              \item Store user's identity token on client browser to achieve auto login.
            \end{enumerate}
      ...
      \item User manage logs.
        \begin{itemize}
          ...
          \item Technology and Data Variations List:
            \begin{itemize}
              \item Start Time and End Time of a log to calculate time period.
              \item Activity type to classify logs.
              \item Description of log.
            \end{itemize}
